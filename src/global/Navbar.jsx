...
const Navbar = () => {
  ...
  // Desktop link classes — underline style active indicator, no pill
  const desktopLink = (isActive) =>
    isActive
      ? [
          "inline-flex items-center relative px-3 py-2 xl:px-4 xl:py-1.5 text-xs xl:text-sm font-semibold transition-all duration-300 ease-in-out",
          "after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2",
          "after:h-[2px] after:w-4/5 after:rounded-full",
          scrolled
            ? "text-[#7fc742] after:bg-[#7fc742]"
            : "text-[#2d7a3a] after:bg-[#2d7a3a]",
        ].join(" ")
      : [
          "inline-flex items-center relative px-3 py-2 xl:px-4 xl:py-1.5 text-xs xl:text-sm font-medium transition-all duration-300 ease-in-out",
          "after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2",
          "after:h-[2px] after:w-0 after:rounded-full after:transition-all after:duration-300",
          scrolled
            ? "text-white/80 hover:text-white after:bg-white hover:after:w-4/5"
            : "text-[#1a3d22]/80 hover:text-[#1a3d22] after:bg-[#2d7a3a] hover:after:w-4/5",
        ].join(" ");

  // Mobile link classes — left-border indicator style
  const mobileLink = (isActive) =>
    isActive
      ? "flex items-center justify-center px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-300 text-[#2d7a3a] bg-[#2d7a3a]/10 border-l-2 border-[#7fc742]"
      : "flex items-center justify-center px-4 py-3 rounded-xl text-sm font-medium transition-all duration-300 text-[#1a3d22]/80 hover:text-[#2d7a3a] hover:bg-[#2d7a3a]/8 border-l-2 border-transparent active:scale-95";

  return (
    <nav
      className={[
        "sticky top-0 z-[1000] transition-all duration-500 ease-in-out border-b",
        scrolled
          ? "bg-[#1a3d22] shadow-[0_8px_32px_rgba(45,122,58,0.25)] border-[rgba(127,199,66,0.2)]"
          : "bg-[#e8f5e0] ",
      ].join(" ")}
    >
      <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12">
        <div className="flex items-center justify-between h-14 sm:h-16 lg:h-15">
          ...
          >
            {scrolled ? (
              ...
              <img
                src={Logo}
                className="h-7 object-contain max-h-10 transform transition-transform duration-300
               xs:h-8 sm:h-9 md:h-10 lg:h-11 xl:h-12 2xl:h-14
               hover:scale-105 filter drop-shadow-lg "
                alt="Jaimax Coin Logo"
                title="Jaimax Coin – Best Pre-Sale Crypto token in India | Smart Investments"
          ...
          <div className="hidden lg:flex items-center space-x-1 xl:space-x-2">
            <ul className="flex items-center space-x-1 xl:space-x-2">
              <li>
                <NavLink
                  className={({ isActive }) =>
                    desktopLink(isActive && location.pathname === "/" && !location.hash)
                  }
                  aria-current="page"
                  to="/"
                  title="Jaimax Coin - India's Leading Pre-Sale Cryptocurrency Platform"
              ...
              <li>
                <NavLink
                  className={[
                    "inline-flex items-center relative px-3 py-2 xl:px-4 xl:py-1.5 text-xs xl:text-sm font-medium whitespace-nowrap",
            ...
            <div
              className={[
                "mx-3 xl:mx-4 w-px h-6 transition-all duration-500",
                scrolled
                  ? "bg-gradient-to-b from-transparent via-white/25 to-transparent"
                  : "bg-gradient-to-b from-transparent via-[#2d7a3a]/30 to-transparent",
              ].join(" ")}
            />
            ...
            <div className="flex items-center space-x-2 xl:space-x-3">
              ...
              >
                <button
                  type="button"
                  className={[
                    "rounded-full px-4 py-1.5 xl:px-5 xl:py-1.5 text-xs xl:text-sm font-semibold",
                    "border transition-all duration-300 ease-in-out hover:scale-105 whitespace-nowrap",
                    scrolled
                      ? "text-white border-white/30 hover:bg-white/10 hover:border-white/60"
                      : "text-[#2d7a3a] border-[#2d7a3a]/40 hover:bg-[#2d7a3a]/8 hover:border-[#2d7a3a]",
                  ].join(" ")}
                >
                  Login
                </button>
              ...
              >
                <button
                  ...
                  className={[
                    ...
                    "border transition-all duration-300 ease-in-out hover:scale-105 whitespace-nowrap",
                    scrolled
                      ? "bg-[#7fc742] text-[#0f2414] border-[#7fc742] hover:bg-[#b8e07c] hover:border-[#b8e07c]"
                      : "bg-[#2d7a3a] text-white border-[#2d7a3a] hover:bg-[#1a3d22] hover:border-[#1a3d22]",
                  ].join(" ")}
                >
                  Register
                </button>
          ...
          <button
            className={[
              "lg:hidden p-2 rounded-lg focus:outline-none focus:ring-2 transition-all duration-200 z-10",
              scrolled
                ? "hover:bg-white/10 focus:ring-white/20"
                : "hover:bg-[#2d7a3a]/10 focus:ring-[#2d7a3a]/20",
            ].join(" ")}
            type="button"
            onClick={toggleNavbar}
            aria-controls="navbarNav"
        ...
        >
          <div className="pb-4 pt-2">
            <div
              className="rounded-2xl shadow-[0_8px_32px_rgba(45,122,58,0.15)] overflow-hidden mt-2 max-h-[80vh] overflow-y-auto border border-[#2d7a3a]/15"
            ...
            >
              <ul className="flex flex-col p-3 sm:p-4 space-y-1">
                <li>
                  <NavLink
                    className={({ isActive }) =>
                      mobileLink(isActive && location.pathname === "/" && !location.hash)
                    }
                    aria-current="page"
                    to="/"
                    title="Jaimax Coin - India's Leading Pre-Sale Cryptocurrency Platform"
                ...
                <li>
                  <NavLink
                    className="flex items-center justify-center px-4 py-3 rounded-xl text-sm font-medium transition-all duration-300 text-[#1a3d22]/80 hover:text-[#2d7a3a] hover:bg-[#2d7a3a]/8 border-l-2 border-transparent active:scale-95"
                    to="/jaimax-whitepaper.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    title="Jaimax Coin Whitepaper - Technical Documentation & Roadmap (PDF)"
                ...
                <li className="pt-4 border-t border-[#2d7a3a]/15 mt-4">
                  <div className="flex flex-col space-y-3">
                    <NavLink
                      to="/login"
                      onClick={closeNavbar}
                    ...
                    >
                      <button
                        type="button"
                        className="w-full text-[#2d7a3a] border border-[#2d7a3a]/40 rounded-xl px-6 py-3 text-sm font-semibold transition-all duration-300 hover:bg-[#2d7a3a]/8 hover:border-[#2d7a3a] active:scale-95"
                      >
                        Login
                      </button>
                    </NavLink>
                    ...
                    >
                      <button
                        type="button"
                        className="w-full bg-[#2d7a3a] text-white border border-[#2d7a3a] rounded-xl px-6 py-3 text-sm font-semibold transition-all duration-300 hover:bg-[#1a3d22] hover:border-[#1a3d22] active:scale-95"
                      >
                        Register
                      </button>
                    </NavLink>
