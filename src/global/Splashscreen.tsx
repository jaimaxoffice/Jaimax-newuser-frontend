  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center bg-black">
      ...
      >
        ...
        >
          <div className="flex flex-col items-center justify-center mb-2 md:mb-4">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-2 md:mb-4">SECURE</h2>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">DATA</h2>
          </div>
          <p className="text-cyan-300 text-sm md:text-lg font-light">End-to-end encryption</p>
          <p className="text-cyan-300 text-sm md:text-lg font-light">Zero-knowledge architecture</p>
        ...
        >
          <div className="flex flex-col items-center justify-center mb-2 md:mb-4">
            <div className="w-12 h-12 md:w-16 md:h-16 border-2 border-orange-400 rounded-full flex items-center justify-center mb-2 md:mb-4">
              <div className="w-3 h-3 md:w-4 md:h-4 bg-orange-400 rounded-full animate-ping"></div>
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-2 md:mb-4">GREAT</h2>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">FUTURE</h2>
          </div>
          <p className="text-orange-300 text-sm md:text-lg font-light">AI-powered trading</p>
          <p className="text-orange-300 text-sm md:text-lg font-light">Next-gen blockchain</p>
      ...
      >
        <div className="text-center">
          <h1
            className={`text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black transition-all duration-800 ease-out ${
              phase === 'logoBlur'
                ? 'blur-lg scale-95'
                : phase === 'settled'
                ? 'blur-none scale-100'
          ...
          >
            <p className="text-gray-300 text-base md:text-xl font-light tracking-widest px-2">
              WHERE SECURITY MEETS INNOVATION
            </p>
