...
//             </div>
//             <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black mb-2 md:mb-4">SECURE</h2>
//             <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black">DATA</h2>
//           </div>
...
//             </div>
//             <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black mb-2 md:mb-4">GREAT</h2>
//             <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black">FUTURE</h2>
//           </div>
