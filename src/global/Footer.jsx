...
//   return (
//     <footer
//       className="relative border-t border-[#2d7a3a]/40"
//       // style={{
//       //   background:
//       //     "linear-gradient(160deg, #1a3d22 0%, #162f1a 60%, #0f2414 100%)",
//       // }}
//     >
//       {/* Decorative gradient overlay */}
//       <div
...
//         style={{
//           background:
//             "radial-gradient(ellipse at top center, rgba(127,199,66,0.15) 0%, transparent 55%)",
//         }}
//       />
...
//                 />
//               </NavLink>
//               <h3 className="text-[#b8e07c] font-semibold text-sm uppercase tracking-wider mb-3 sm:mb-4">
//                 Company
//               </h3>
//               <p className="text-white/70 text-sm leading-relaxed mb-4 sm:mb-6 max-w-xs mx-auto sm:mx-0">
//                 Join Jaimax Coin today to embark on a secure, user-friendly, and
//                 comprehensive cryptocurrency investment journey. Experience the
//                 future of digital asset management with it.
//               </p>
...
//               {/* Connect With section */}
//               <h4 className="text-[#b8e07c] font-semibold text-sm uppercase tracking-wider mb-3 sm:mb-4">
//                 Connect with
//               </h4>
//               <div className="flex flex-wrap justify-center sm:justify-start gap-2 sm:gap-3 max-w-xs mx-auto sm:mx-0">
//                 {[
...
//                     key={social.name}
//                     href={social.url}
//                     className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/8 border border-[#4a9858]/30 flex items-center justify-center text-white/70 transition-all duration-300 ${social.hoverBg} hover:text-white hover:scale-110 hover:shadow-lg hover:border-transparent active:scale-95`}
//                     title={social.title}
//                     aria-label={`Follow us on ${social.name}`}
//                     target="_blank"
//                     rel="noopener noreferrer"
...
//             {/* Quick Links */}
//             <div className="text-start sm:text-left">
//               <h3 className="text-[#b8e07c] font-semibold text-sm uppercase tracking-wider mb-4 sm:mb-6">
//                 Quick Links
//               </h3>
//               <ul className="space-y-2 sm:space-y-3">
//                 {[
...
//                       target={link.external ? "_blank" : undefined}
//                       title={link.title}
//                       className="text-white/60 text-sm transition-all duration-300 hover:text-[#b8e07c] hover:translate-x-1 inline-block relative group"
//                     >
//                       {link.name}
//                       <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-gradient-to-r from-[#7fc742] to-[#b8e07c] transition-all duration-300 group-hover:w-full"></span>
//                     </NavLink>
//                   </li>
//                 ))}
//               </ul>
...
//                 Stay Updated
//               </h3>
//               <p className="text-white/60 text-sm mb-4 max-w-xs mx-auto sm:mx-0">
//                 Get the latest crypto insights and Jaimax updates delivered to
//                 your inbox.
//               </p>
...
//                     rel="noopener noreferrer"
//                     title="Join our Telegram community for instant updates and announcements"
//                     className="flex items-center justify-center gap-2 w-full py-2.5 px-4 text-white text-sm font-medium no-underline rounded-lg bg-[#229ED9] hover:bg-[#1a8fc7] transition-colors duration-300 shadow-md hover:shadow-lg"
//                   >
//                     <svg
//                       className="w-4 h-4"
//                       fill="currentColor"
...
//                     rel="noopener noreferrer"
//                     title="Subscribe to Jaimax newsletter on LinkedIn for professional insights"
//                     className="flex items-center justify-center gap-2 w-full py-2.5 px-4 text-[#0f2414] text-sm font-medium no-underline rounded-lg bg-[#7fc742] hover:bg-[#b8e07c] transition-colors duration-300 shadow-md hover:shadow-lg"
//                   >
//                     <svg
//                       xmlns="http://www.w3.org/2000/svg"
//                       width="16"
...
//         {/* Bottom section */}
//         <div className="border-t border-[#2d7a3a]/30">
//           <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
//             <div className="flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0">
//               {/* Copyright */}
//               <div className="flex items-center justify-center text-white/40 text-sm text-center w-full">
//                 copyright © 2025 Jaimax Coin. All rights reserved.
//               </div>
...
//                 aria-label="Scroll to top"
//                 title="Back to top - Scroll to the top of the page"
//                 className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/8 border border-[#4a9858]/30 flex items-center justify-center text-white/60 transition-all duration-300 hover:bg-[#7fc742] hover:text-[#0f2414] hover:border-[#7fc742] hover:scale-110 hover:shadow-lg active:scale-95 order-3"
//               >
//                 <svg
//                   xmlns="http://www.w3.org/2000/svg"
//                   width="20"
...
//           style={{
//             background:
//               "linear-gradient(90deg, transparent 0%, #7fc742 50%, transparent 100%)",
//           }}
//         />
//       </div>
//     </footer>
...
const Footer = () => {
  ...
  return (
    <footer
      className="relative"
      style={{ background: "#e8f5e0", backdropFilter: "blur(2px)" }}
    >
      {/* ── Soft gradient top edge (removes sharp border) ── */}
      <div
        className="absolute top-0 left-0 right-0 h-12 pointer-events-none z-10"
        style={{
          background:
            "linear-gradient(to bottom, rgba(180,220,160,0.4), transparent)",
        }}
      />
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-8">
            ...
            <div className="sm:col-span-2 lg:col-span-1 text-start sm:text-left">
              ...
              <h3 className="text-[#2d7a3a] font-semibold text-sm uppercase tracking-wider mb-3 sm:mb-4">
                Company
              </h3>
              <p className="text-black text-sm leading-relaxed mb-4 sm:mb-6 max-w-xs mx-auto sm:mx-0">
                Join Jaimax Coin today to embark on a secure, user-friendly, and
                comprehensive cryptocurrency investment journey. Experience the
                future of digital asset management with it.
              </p>
              ...
              {/* Connect With */}
              <h4 className="text-[#2d7a3a] font-semibold text-sm uppercase tracking-wider mb-3 sm:mb-4">
                Connect with
              </h4>
              <div className="flex flex-wrap justify-center sm:justify-start gap-2 sm:gap-3 max-w-xs mx-auto sm:mx-0">
                {[
                  ...
                  <a
                    key={social.name}
                    href={social.url}
                    className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-transparent border border-[#4a9858]/40 flex items-center justify-center text-gray-800 transition-all duration-300 ${social.hoverBg} hover:text-white hover:scale-110 hover:shadow-lg hover:border-transparent active:scale-95`}
                    title={social.title}
                    aria-label={`Follow us on ${social.name}`}
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            {/* ── Quick Links ── */}
            <div className="text-start sm:text-left">
              <h3 className="text-[#2d7a3a] font-semibold text-sm uppercase tracking-wider mb-4 sm:mb-6">
                Quick Links
              </h3>
              <ul className="space-y-2 sm:space-y-3">
                {[
                  ...
                  { name: "Blogs", path: "/blog/", title: "Read our latest crypto insights and articles" },
                  { name: "Contact", path: "/contact/", title: "Get in touch with Jaimax support team" },
                  { name: "White Paper", path: "/jaimax-whitepaper.pdf", external: true, title: "Download Jaimax Coin whitepaper (PDF)" },
                  { name: "Incorporation Certificate", path: "/IncorporationCertificate.pdf", external: true, title: "View Jaimax company incorporation certificate (PDF)" },
                  { name: "Recognition Certificate", path: "/RecognitionCertificate.pdf", external: true, title: "View Jaimax recognition certificate (PDF)" },
                  { name: "GST Registration Certificate", path: "/GSTRegistrationCertificate.pdf", external: true, title: "View Jaimax GST registration certificate (PDF)" },
                  { name: "ISO certification", path: "/Isocertified.pdf", external: true, title: "View Jaimax ISO certification (PDF)" },
                ].map((link) => (
                  <li key={link.name}>
                    <NavLink
                      to={link.path}
                      target={link.external ? "_blank" : undefined}
                      title={link.title}
                      className="text-[#374151] text-sm transition-all duration-300 hover:text-[#2d7a3a] hover:translate-x-1 inline-block relative group"
                    >
                      {link.name}
                      <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-gradient-to-r from-[#7fc742] to-[#2d7a3a] transition-all duration-300 group-hover:w-full"></span>
                    </NavLink>
                  </li>
                ))}
              </ul>
            ...
            <div className="text-start sm:text-left">
              ...
              <ul className="space-y-2 sm:space-y-3">
                {[
                  { name: "24/7 Support", path: "/supportpage/", title: "Get 24/7 customer support and assistance" },
                  { name: "Refund Policy", path: "/refund-policy/", title: "Read our refund and cancellation policy" },
                  { name: "Terms and Conditions", path: "/terms-and-conditions", title: "Read Jaimax terms and conditions" },
                  { name: "Privacy Policy", path: "/privacy-policy/", title: "View our privacy policy and data protection" },
                  { name: "KYC_PMLA", path: "/kyc-pmla/", title: "Learn about KYC and PMLA compliance" },
                  { name: "AML_CTF", path: "/aml-ctf/", title: "View anti-money laundering and counter-terrorism financing policy" },
                ].map((link) => (
            ...
            <div className="text-start sm:text-left">
              ...
              <p className="text-[#374151] text-sm mb-4 max-w-xs mx-auto sm:mx-0">
                Get the latest crypto insights and Jaimax updates delivered to
                your inbox.
              </p>
              ...
              <form className="space-y-6 max-w-xs mx-auto sm:mx-0">
                ...
                <div className="mb-4">
                  <a
                    ...
                    rel="noopener noreferrer"
                    title="Subscribe to Jaimax newsletter on LinkedIn for professional insights"
                    className="flex items-center justify-center gap-2 w-full py-2.5 px-4 text-[#0f2414] text-sm font-medium no-underline rounded-lg bg-[#7fc742] hover:bg-[#6ab535] transition-colors duration-300 shadow-md hover:shadow-lg"
                  >
        ...
        {/* ── Bottom bar ── */}
        <div className="border-t border-[#4a9858]/25">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            <div className="flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0">
              {/* Copyright */}
              <div className="flex items-center justify-center text-[#4b5563] text-sm text-center w-full">
                copyright © 2025 Jaimax Coin. All rights reserved.
              </div>
              ...
              <button
                ...
                aria-label="Scroll to top"
                title="Back to top - Scroll to the top of the page"
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-transparent border border-[#4a9858]/40 flex items-center justify-center text-[#2d7a3a] transition-all duration-300 hover:bg-[#2d7a3a] hover:text-white hover:border-[#2d7a3a] hover:scale-110 hover:shadow-lg active:scale-95 order-3"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                  viewBox="0 0 24 24" fill="none" stroke="currentColor"
                  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                  className="w-4 h-4 sm:w-5 sm:h-5" aria-hidden="true">
                  <path d="m5 12 7-7 7 7" />
                  <path d="M12 19V5" />
                </svg>
              </button>
