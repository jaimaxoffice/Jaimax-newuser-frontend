  ...
  return (
    <>
      <style>
        {`
          @keyframes fadeInUp {
            from { opacity: 0; transform: translate(-50%, -40%) translateY(20px); }
          ...
          @keyframes glow {
            ...
            50% { box-shadow: 0 0 20px rgba(106, 103, 103, 0.8); }
          }
          .animate-fade-in-up { animation: fadeInUp 0.8s ease-out; }
          .animate-flip { animation: flip 0.6s ease-in-out; }
          .animate-scale { animation: scaleUp 0.9s ease-in-out; }
          .animate-glow { animation: glow 2s ease-in-out infinite; }
          @keyframes pulseExplosion {
            0% { transform: scale(1); box-shadow: 0 0 5px rgba(255,255,255,0.5); }
            50% { transform: scale(1.25); box-shadow: 0 0 30px rgba(101, 97, 97, 1); }
            100% { transform: scale(1); box-shadow: 0 0 5px rgba(255,255,255,0.5); }
          }
          @keyframes neonFlicker {
            0%, 19%, 21%, 23%, 25%, 54%, 100% {
              opacity: 1; text-shadow: 0 0 5px #fff, 0 0 10px #0ff, 0 0 20px #0ff;
            }
          ...
          .animate-pulse-explosion { animation: pulseExplosion 1.3s ease-in-out infinite; }
          .animate-neon-flicker { animation: neonFlicker 2.5s linear infinite; }
          .animate-shockwave { animation: shockwaveBounce 0.9s ease-in-out; }
        `}
      </style>
      ...
      <div className="relative w-full">
        ...
        <div className="absolute top-[80%] min-[640px]:top-[25%] md:top-[50%] left-[23%] min-[640px]:left-[28%] md:left-[30%] -translate-x-1/2 -translate-y-1/2 z-10 mb-2">
          <div className="rounded-lg p-3 sm:p-4 md:p-6 transition-all duration-300">
            <h6 className="hidden sm:block text-white text-[8px] sm:text-xs md:text-sm font-bold mb-2 md:mb-4 text-center">
              Time Remaining
            </h6>
            <div className="flex gap-1.5 md:gap-4">
              <div className="text-center">
                <div className="bg-white/20 rounded-[5px] p-1.5 sm:md:p-0 md:p-3 min-w-[20px] sm:max-w-[20px] md:min-w-[60px] hover:bg-white/30 transition-all duration-300 hover:scale-110">
                  <span key={timeLeft.days} className="text-[9px] md:text-sm sm:text-[5px] font-semibold text-white block animate-flip">
                    {String(timeLeft.days).padStart(2, "0")}
                  </span>
                </div>
                <p className="text-white text-[6px] sm:text-[5px] md:text-xs mt-1 md:mt-2">Days</p>
              ...
              <div className="text-center">
                <div className="bg-white/20 rounded-[5px] p-1.5 md:p-3 sm:md:p-0 min-w-[20px] sm:min-w-[20px] md:min-w-[60px] hover:bg-white/30 transition-all duration-300 hover:scale-110">
                  <span key={timeLeft.hours} className="text-[9px] md:text-sm sm:text-[5px] font-semibold text-white block animate-flip">
                    {String(timeLeft.hours).padStart(2, "0")}
                  </span>
                </div>
                <p className="text-white text-[6px] sm:text-[5px] md:text-xs mt-1 md:mt-2">Hours</p>
              </div>
              <div className="text-center">
                <div className="bg-white/20 rounded-[5px] p-1.5 md:p-3 sm:md:p-0 min-w-[20px] sm:min-w-[20px] md:min-w-[60px] hover:bg-white/30 transition-all duration-300 hover:scale-110">
                  <span key={timeLeft.minutes} className="text-[9px] md:text-sm sm:text-[5px] font-semibold text-white block animate-flip">
                    {String(timeLeft.minutes).padStart(2, "0")}
                  </span>
                </div>
                <p className="text-white text-[6px] sm:text-[5px] md:text-xs mt-1 md:mt-2">Minutes</p>
              </div>
              <div className="text-center">
                <div className="bg-white/80 rounded-[5px] p-1.5 md:p-3 sm:md:p-0 min-w-[20px] sm:min-w-[20px] md:min-w-[60px] hover:bg-gray-100 transition-all duration-300 hover:scale-110 animate-glow animate-pulse-explosion">
                  <span key={timeLeft.seconds} className="text-[9px] md:text-sm sm:text-xs font-semibold text-black block animate-scale animate-shockwave animate-neon-flicker">
                    {String(timeLeft.seconds).padStart(2, "0")}
                  </span>
                </div>
                <p className="text-white text-[6px] sm:text-xs md:text-xs mt-1 md:mt-2">Seconds</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full overflow-hidden">
          <img src={desktopcoin} alt="Desktop Coin" className="hidden md:block w-full h-auto object-contain" />
          <img src={mobilecoin} alt="Mobile Coin" className="block md:hidden w-full h-auto object-contain" />
        </div>
      </div>
    </>
  );
