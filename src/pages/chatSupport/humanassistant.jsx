...
// import { useGetChatSupportDataMutation } from "./chatApi.js";
...
//   const [getChatSupportData, { isLoading, error }] =
...
//         "http://localhost:3002/api/icoRound/getUserLocation",
//         {
//           method: "POST",
...
//       setStatus("Query submitted successfully! Address: " + data.address);
//       setStep(5);
...
//         ? null // Skip adding a bot message
//         : {
//             type: "bot",
...
//   // Language Selection Screen - FULL SCREEN FOR SMALL DEVICES
...
//         className="
//     fixed bottom-0 right-0 w-full h-full   /* default for small screens */
//     md:bottom-[5.75rem] md:right-1 md:w-96 md:h-[550px] 
//     lg:w-[350px] md:max-w-md md:max-h-[80vh] md:rounded-2xl
//     bg-white shadow-2xl flex flex-col overflow-hidden z-[9999]
//   "
//       >
//         {/* Header */}
//         <div
//           className="bg-gradient-to-r from-[#085056] to-[#0a6e74] text-white 
//             p-4 md:p-4 font-semibold text-lg md:text-lg 
...
//             {/* Back Arrow */}
//             <button
//               onClick={onclose} // Replace with your go-back function
//               className="text-white text-2xl md:text-2xl p-2 rounded-full hover:bg-white/20 transition"
//             >
//               <HiArrowLeft /> {/* <-- Import from react-icons/hi */}
//             </button>
...
//                    object-contain rounded-full border-2 border-white/30 shadow-md"
//               />
//             </div>
...
//             <div
//               onClick={onclose}
//               className="flex flex-col P-5 font-bold leading-tight text-base md:text-base"
//             >
//               <SlArrowDown size={20} />
//             </div>
//           </div>
...
//                         p-6 md:p-6 
//                         bg-gradient-to-b from-gray-50 to-white overflow-y-auto"
//         >
//           <motion.div
//             initial={{ scale: 0 }}
//             animate={{ scale: 1 }}
...
//                             rounded-full bg-gradient-to-br from-[#085056] to-[#0a6e74] 
...
//               className="w-full bg-white border-2 border-gray-200 hover:border-[#085056] 
//                          text-gray-800 font-semibold 
//                          py-4 md:py-3 
//                          px-6 md:px-5 
//                          rounded-xl md:rounded-xl 
//                          transition-all shadow-md hover:shadow-lg 
//                          flex items-center gap-4 md:gap-3 group"
//             >
//               <span className="text-3xl md:text-2xl">🇬🇧</span>
//               <div className="flex-1 text-left">
//                 <div className="text-lg md:text-base font-bold">English</div>
//               </div>
//               <span
//                 className="text-[#085056] opacity-0 group-hover:opacity-100 
//                                transition-opacity text-xl md:text-lg"
//               >
//                 →
//               </span>
//             </motion.button>
...
//               <span className="text-3xl md:text-2xl">🇮🇳</span>
//               <div className="flex-1 text-left">
//                 <div className="text-lg md:text-base font-bold">हिंदी</div>
//               </div>
//               <span
//                 className="text-[#085056] opacity-0 group-hover:opacity-100 
//                                transition-opacity text-xl md:text-lg"
...
//               <span className="text-3xl md:text-2xl">🇮🇳</span>
//               <div className="flex-1 text-left">
//                 <div className="text-lg md:text-base font-bold">తెలుగు</div>
//               </div>
//               <span
//                 className="text-[#085056] opacity-0 group-hover:opacity-100 
//                                transition-opacity text-xl md:text-lg"
...
//         {/* Footer */}
//         <div
//           className="bg-gradient-to-r from-[#085056] to-[#0a6e74] 
//                         py-4 md:py-4 
//                         px-4 md:px-4"
//         >
//           <p
//             className="text-center text-sm md:text-xs text-white/90 
//                         flex items-center justify-center gap-1 select-none font-medium"
//           >
//             <span>⚡</span>
...
//   // Loading state - FULL SCREEN FOR SMALL DEVICES
//   if (loading) {
//     return (
//       <motion.div
//         initial={{ opacity: 0, scale: 0.9 }}
...
//           <div className="relative">
//             <div
//               className="animate-spin rounded-full h-20 w-20 md:h-16 md:w-16 
//                             border-4 border-gray-200 border-t-[#085056] mx-auto"
//             ></div>
//             <img
//               src={logo}
//               alt="Logo"
...
//   // Main Chat Interface - FULL SCREEN FOR SMALL DEVICES
//   return (
//     <motion.div
...
//       className={`fixed bottom-0 right-0 w-full   /* default small screens */
//               md:bottom-[6rem] md:right-1 md:w-96 lg:w-[350px]
//               md:max-w-md md:rounded-2xl
//               bg-white shadow-2xl flex flex-col overflow-hidden
//               transition-all duration-300 z-[9999] ${
//                 isMinimized
//                   ? "h-16 md:h-16"
//                   : "h-full md:h-[550px] md:max-h-[80vh]"
//               }`}
//       role="region"
...
//           {/* Back Arrow */}
//           <button
//             onClick={handleReset} // Replace with your go-back function
//             className="text-white text-2xl md:text-2xl p-2 rounded-full hover:bg-white/20 transition"
//           >
//             <HiArrowLeft /> {/* <-- Import from react-icons/hi */}
//           </button>
...
//           <div
//             onClick={onclose}
//             className="flex flex-col  font-bold leading-tight text-base md:text-base"
//           >
//             <SlArrowDown size={20} />
//           </div>
//         </div>
...
//             className={`flex-1 p-4 md:p-4 
//                         space-y-4 md:space-y-4 
//                         bg-gradient-to-b from-gray-50 to-white font-[Poppins]  ${
//                           menuOpen
//                             ? "pointer-events-none opacity-50 overflow-hidden shadow-none"
//                             : "overflow-y-auto"
//                         }`}
//             style={{
...
//                                   rounded-full border-2 border-[#085056]    mb-1 ${
//                                     menuOpen ? "shadow-none" : "shadow-md"
//                                   }`}
//                     />
//                   )}
//                   <div
...
//                 text-sm md:text-sm font-poppins 
//                 ${
//                   entry.type === "bot"
...
//                       aria-label={`${
//                         entry.type === "bot" ? "Bot message" : "User message"
//                       }: ${entry.text}`}
//                     >
//                       <ReactMarkdown
//                         components={{
...
//                             <p
//                               {...props}
//                               className="mb-2 last:mb-0 font-poppins"
//                             >
//                               {props.children}
//                             </p>
//                           ),
...
//                         border-2 border-gray-200 hover:border-[#085056] 
//                         text-sm md:text-sm 
//                         py-3 md:py-2.5 
//                         px-4 md:px-4 
//                         rounded-xl md:rounded-xl 
//                         transition-all text-left font-poppins font-semibold
//                         text-gray-700 hover:text-[#085056] 
//                         ${menuOpen ? "shadow-none" : "shadow-xl"}`}
...
//                       className={`w-10 h-10 md:w-8 md:h-8 
//                                   rounded-full bg-gradient-to-br from-[#085056] to-[#0a6e74] 
//                                   flex items-center justify-center text-white mb-1 select-none ${
//                                     menuOpen ? "shadow-none" : "shadow-md"
//                                   }`}
//                     >
...
//                         textAlign: "center",
//                       }}
//                       className="md:text-lg md:mb-1.5"
//                     >
...
//                     />
//                     <button
//                       onClick={() => (name && phone && email ? setStep(2) : "")}
//                       style={{
//                         width: "100%",
//                         padding: "12px",
//                         marginTop: "14px",
...
//                         lineHeight: "1.5",
//                       }}
//                       className="md:text-xs md:mb-4.5"
//                     >
...
//                         color: "#fff",
//                       }}
//                       className="md:text-base md:mb-1.5"
//                     >
//                       Query Submitted!
//                     </h3>
...
//                         lineHeight: "1.4",
//                       }}
//                       className="md:text-[11px] md:mb-3.5"
//                     >
...
//                     alt="Bot"
//                     className={`w-10 h-10 md:w-8 md:h-8 
//                                 rounded-full border-2 border-[#085056] ${
//                                   menuOpen ? "shadow-none" : "shadow-md"
//                                 }`}
//                   />
//                   <div
//                     className={`bg-white px-5 md:px-5 
//                                 py-3 md:py-3 
//                                 rounded-2xl md:rounded-2xl rounded-tl-none 
...
//                       <div
//                         className="w-2.5 h-2.5 md:w-2.5 md:h-2.5 
//                                    bg-[#085056] rounded-full animate-bounce"
//                         style={{ animationDelay: "0ms" }}
//                       ></div>
//                       <div
//                         className="w-2.5 h-2.5 md:w-2.5 md:h-2.5 
...
//                           border-t bg-white shadow-lg 
//                           flex flex-col space-y-3 md:space-y-3"
//           >
//             <div
...
//                 className="bg-gradient-to-r from-[#085056] to-[#0a6e74] 
//                            hover:from-[#0a6e74] hover:to-[#085056] 
//                            text-white 
...
//           >
//             <p
//               className="text-center text-sm md:text-xs 
//                           text-white/90 flex items-center justify-center gap-1 
