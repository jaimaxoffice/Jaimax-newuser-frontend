  ...
  return (
    <section className="bg-[#085056] py-8 sm:py-12 lg:py-16 px-4">
      ...
      <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="flex flex-col justify-center">
          {/* Arrow note */}
          <div className="flex items-start gap-3 sm:gap-4 px-4 sm:px-6 lg:px-12 xl:px-16 mb-6 sm:mb-8">
            {/* Unified arrow (line + head) */}
            <svg
              className="flex-shrink-0 w-20 sm:w-24 md:w-32 lg:w-40 xl:w-52 h-4 sm:h-5 mt-1 text-[#b9cd27]"
              viewBox="0 0 120 20"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
            ...
            {/* Description */}
            <p className="text-white/90 text-xs sm:text-sm lg:text-base leading-relaxed max-w-xs sm:max-w-sm lg:max-w-md">
              Great! We're excited to hear from you – let's start something
              special together. Call us for any inquiry.
            </p>
          </div>
