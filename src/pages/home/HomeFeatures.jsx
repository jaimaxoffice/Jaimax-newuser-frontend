      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid gap-8 sm:gap-12 lg:gap-16 lg:grid-cols-2 p-4 sm:p-5 items-center">
          ...
          <div className="flex flex-col justify-center space-y-4 sm:space-y-6 order-1 lg:order-2 text-center lg:text-left">
            ...
            >
              Welcome to <strong className="text-lime-400">Jaimax</strong>, one
              of the best crypto coins designed for growth, transparency, and
              financial freedom. Built on powerful blockchain technology, Jaimax
              offers a secure and scalable platform for users who want to be
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 lg:mb-16">
              ...
              >
                Discover the powerful features that make Jaimax the perfect
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-12 lg:py-8">
          <div className="rounded-3xl p-4 sm:p-6 lg:p-8">
            <div className="text-center">
              ...
              >
                Jaimax goes beyond being a crypto coin — it's a full-stack
                platform built for secure, scalable, and user-focused crypto
                solutions.
              </motion.p>
