    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-12 lg:py-8">
      <div className="rounded-3xl p-4 sm:p-6 lg:p-8">
        <div className="text-center">
          ...
          >
            Why{" "}
            <Link to="/about" title="Why choose Jaimax crypto">
              <span className="text-lime-400 hover:underline">Jaimax</span>
            </Link>{" "}
            Stands Out
          </motion.h2>
          ...
          >
            <Link to="/about" title="About Jaimax platform" className="text-lime-400 hover:underline">
              Jaimax
            </Link>{" "}
            goes beyond being a crypto coin — it's a full-stack platform built for{" "}
            <Link to="/services" title="Jaimax secure crypto services" className="text-lime-400 hover:underline">
              secure, scalable, and user-focused crypto solutions
            </Link>.
          </motion.p>
          ...
          >
            {/* Uptime - Link to Services */}
            <Link to="/services" title="Jaimax platform uptime guarantee">
              <motion.div
                variants={itemVariants}
                className="rounded-xl text-center bg-slate-800 border border-slate-700 hover:border-lime-400/50 p-4 sm:p-5 lg:p-6 transition-all duration-300 hover:scale-105"
              >
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-lime-400">
                  99.9%
                </div>
                <div className="text-gray-300 text-xs sm:text-sm lg:text-base font-medium mt-1">
                  Uptime Guarantee
                </div>
              </motion.div>
            </Link>
            ...
            {/* Users - Link to About */}
            <Link to="/about" title="Jaimax active users community">
              <motion.div
                variants={itemVariants}
                className="rounded-xl text-center bg-slate-800 border border-slate-700 hover:border-lime-400/50 p-4 sm:p-5 lg:p-6 transition-all duration-300 hover:scale-105"
              >
            ...
            <Link to="/contact" title="Contact Jaimax 24/7 support">
              <motion.div
                variants={itemVariants}
                className="rounded-xl text-center bg-slate-800 border border-slate-700 hover:border-lime-400/50 p-4 sm:p-5 lg:p-6 transition-all duration-300 hover:scale-105"
              >
