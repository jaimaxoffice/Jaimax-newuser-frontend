...
//         "Team assembly and partnerships",
...
//       progress: 65,
//       phases: [
//         "Platform beta launch and testing",
...
//         style={{
//           background: 'radial-gradient(ellipse at center, #085056 0%, #064248 50%, #042a2e 100%)',
//           minHeight: '100vh'
//         }}
//       >
//         {/* Animated Background Elements */}
...
//             style={{ backgroundColor: 'rgba(6, 182, 212, 0.1)', animationDelay: '1000ms' }}
//           />
//         </div>
...
//           style={{
//             background: 'linear-gradient(to bottom, rgba(8, 80, 86, 0.95) 0%, transparent 100%)',
...
//             Roadmap
//           </h2>
//           <p className="text-center mt-2 text-sm" style={{ color: 'rgba(153, 246, 228, 0.6)' }}>
...
//                       className="w-full h-full"
//                       style={{
//                         background: 'linear-gradient(to right, rgba(20, 184, 166, 0.6) 0%, rgba(6, 182, 212, 0.4) 50%, transparent 100%)'
//                       }}
//                     />
//                     <div 
...
//                     border
//                     ${isCompleted ? 'border-teal-400/30' : isActive ? 'border-cyan-400/30' : 'border-slate-500/30'}
//                   `}
//                   style={{
...
//                     style={{
//                       background: 'linear-gradient(to top, rgba(0, 0, 0, 0.2) 0%, transparent 50%, rgba(255, 255, 255, 0.05) 100%)'
//                     }}
//                   />
...
//                       style={{
//                         background: 'linear-gradient(to right, rgba(20, 184, 166, 0.2), rgba(6, 182, 212, 0.2), rgba(20, 184, 166, 0.2))'
//                       }}
//                     />
//                   )}
...
//                     <div
//                       className={`
//                         absolute -top-10 -left-3 w-16 h-16 sm:w-18 sm:h-18 rounded-2xl 
...
//                         style={{
//                           background: 'linear-gradient(to right, #ffffff 0%, #ccfbf1 50%, #a5f3fc 100%)',
...
//                         `}
//                         style={{ 
//                           color: isCompleted || isActive ? '#042f2e' : '#e2e8f0'
//                         }}
//                       >
//                         {config.badge}
//                       </span>
...
//                               : 'none',
//                             ringColor: isCompleted ? 'rgba(20, 184, 166, 0.3)' : isActive ? 'rgba(6, 182, 212, 0.3)' : 'rgba(100, 116, 139, 0.3)',
...
//                 style={{
//                   background: 'linear-gradient(to right, rgba(20, 184, 166, 0.1) 0%, rgba(6, 182, 212, 0.1) 50%, rgba(20, 184, 166, 0.1) 100%)'
//                 }}
//               />
...
//                   style={{
//                     background: 'linear-gradient(to right, #99f6e4 0%, #ffffff 50%, #a5f3fc 100%)',
//                     WebkitBackgroundClip: 'text',
//                     WebkitTextFillColor: 'transparent',
//                     backgroundClip: 'text'
//                   }}
...
// <section
//   ref={servicesRef}
//   className="min-h-screen relative px-4 py-20 bg-white flex items-center justify-center overflow-hidden"
// >
//   {/* Background decorations */}
