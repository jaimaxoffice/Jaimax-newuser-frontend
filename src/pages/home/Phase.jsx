          ...
          {phaseData.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Phase tooltip (only on hover) */}
                <div
                  className={`
                    absolute top-[56px] text-yellow-300 font-semibold text-center
                ...
                <article
                  className="mt-4 sm:mt-6 md:mt-16 bg-teal-700 rounded-lg p-4 sm:p-5 shadow-md relative w-full"
                  style={{ minHeight: "180px", width: "250px", maxWidth: "100%" }}
                >
                  {/* Status chip */}
                  <div className="relative">
                    <p
                      className={`
                        ...
                        ${status === "Live"
                          ...
                          : "bg-[#b8cc26] text-black absolute right-2"}
                      `}
                      style={status !== "Live" ? { width: "max-content", top: "-30px", left: "80px" } : {}}
                    >
                      {status === "Live" ? (
                        <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                      ) : (
                  ...
                  >
                    ...
                    <div className="text-center">
                      <button
                        onClick={() => handleBuyNow(item)}           // ⬅️ NEW
                        className={`
                          px-4 sm:px-6 py-1 sm:py-2 rounded-full text-[10px] sm:text-xs font-semibold whitespace-nowrap
                          ${status === "Live"
                            ? "bg-[#b8cc26] text-teal-900 hover:opacity-90"
                ...
                {idx < phaseData.length - 1 && (
                  <div className="absolute md:hidden -bottom-8 w-1 h-16 bg-teal-600" aria-hidden="true" />
                )}
              </div>
            );
          })}
