        ...
        <form onSubmit={handleTicket} className="p-4 space-y-4 text-sm sm:p-6 sm:text-base"> {/* Adjusted padding and font size for responsiveness */}
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-[#1d8d84] bg-white rounded-md border border-teal-300 px-3 py-1.5 focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200 outline-none"
            />
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <label
                htmlFor="file-upload"
                className="flex cursor-pointer  bg-white items-center gap-1 rounded-md border border-teal-300 px-3 py-1.5 text-sm text-teal-700 hover:bg-teal-50 transition-colors duration-200"
              >
