      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
            ...
            <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 flex-1">
                ...
                <div className="hidden sm:flex items-center gap-3">
                  ...
                  <div className="relative">
                    <select
                      className="appearance-none bg-white border border-gray-300 text-gray-700 rounded-lg pl-3 pr-8 py-3 focus:outline-none focus:border-teal-500 transition-colors shadow-sm"
                      value={state?.perPage}
                      onChange={(e) => {
        ...
        {isLoading || loading ? (
          ...
          <>
              ...
              {transformedData.map((item, idx) => (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-4">
                    ...
                    <div
                      className={`flex-shrink-0 px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wide border ${getStatusColor(item.status)}`}
                    >
                      {item.status}
                    </div>
                  </div>
            ...
            {/* Desktop Table - Using ReusableTable */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <Link
                to="/support"
                className="bg-teal-700 hover:bg-teal-600 p-2 rounded-md transition-colors"
              >
            ...
            <div className="flex items-center space-x-2">
              <div
                className={`w-3 h-3 rounded-full ${onlineStatus ? "bg-green-400" : "bg-gray-400"}`}
              ></div>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6 text-teal-900 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-bold text-teal-600 mb-2">
                    Name
                  </label>
                  <p className="bg-gray-100 rounded-md px-4 py-3 font-medium">
                    {data?.data?.ticket?.author_name
                      ? data.data.ticket.author_name.charAt(0).toUpperCase() +
                        data.data.ticket.author_name.slice(1).toLowerCase()
                      : "—"}
                  </p>
                </div>
                <div>
              ...
              {!data?.data?.comments?.length ? (
                ...
                data?.data?.comments?.map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`max-w-xs lg:max-w-md ${isAdmin ? "order-2" : "order-1"}`}
                      >
                        <div
                          className={`flex items-center space-x-2 mb-1 ${isAdmin ? "justify-end" : "justify-start"}`}
                        >
                          <img
                            src={
                        ...
                        <div
                          className={`text-xs text-gray-500 mt-1 ${isAdmin ? "text-right" : "text-left"}`}
                        >
