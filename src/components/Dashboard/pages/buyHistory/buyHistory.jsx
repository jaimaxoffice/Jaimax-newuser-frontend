...
//     {
//       header: "S.No",
//       render: (row, rowIndex) => (state.currentPage - 1) * parseInt(state.perPage) + rowIndex + 1
//     },
//     {
//       header: "Transaction ID",
//       render: (row) => row.paypalTransactionId || row.transactionId || row.orderId || "N/A"
//     },
//     {
//       header: "Payment Mode",
  ...
  return (
    <div className="min-h-screen bg-[#1d8e85] p-2 sm:p-4 lg:p-8">
      <div className="container mx-auto max-w-screen">
        ...
        <div className="hidden lg:block bg-white rounded-xl overflow-hidden border border-gray-200 shadow-lg">
          <ReusableTable 
            columns={columns} 
            data={TableData} 
            isLoading={isLoading || loading} 
