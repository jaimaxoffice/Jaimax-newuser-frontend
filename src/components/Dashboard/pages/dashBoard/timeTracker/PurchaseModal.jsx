        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <span className="text-xs bg-teal-100 text-teal-700 px-2 py-1 rounded tabular-nums">
                      {item.resolvedQty?.toLocaleString()} Coins
                    </span>
                  </div>
                  <div className="space-y-2 text-sm">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-blue-700 tabular-nums">
                    ₹{purchaseCoinsBreakup?.atPriceInr}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-blue-600">USD:</span>
                  <span className="font-medium text-blue-700 tabular-nums">
                    ${purchaseCoinsBreakup?.atPriceUsdt}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-gray-800 tabular-nums">
                    {(
                      Number(purchaseCoinsBreakup?.effectiveAmount) || 0
                    ).toFixed(2)}{" "}
                    {currency}
                  </span>
                </div>
          ...
          <div className="hidden sm:block overflow-x-auto border border-gray-200 rounded-lg">
            <table className="w-full text-sm text-gray-700 table-fixed">
              ...
              <tfoot className="font-medium">
                {/* Token Price */}
                <tr className="bg-blue-50 text-blue-700 border-t border-gray-200">
                  <td className="px-4 py-3 text-left">Token Price</td>
                  <td className="px-4 py-3 text-right tabular-nums">
                    ₹{purchaseCoinsBreakup?.atPriceInr}
                  </td>
                ...
                <tr className="bg-orange-50 text-orange-700">
                  <td className="px-4 py-3 text-left">Charges</td>
                  <td className="px-4 py-3 text-right text-orange-300">—</td>
                  <td className="px-4 py-3 text-right tabular-nums font-semibold">
                    {(Number(purchaseCoinsBreakup?.charges) || 0).toFixed(2)}
                  </td>
                  <td className="px-4 py-3 text-right text-orange-300">—</td>
                ...
                <tr className="bg-teal-100 text-teal-800 font-bold">
                  <td className="px-4 py-3 text-left">Total Coins</td>
                  <td className="px-4 py-3 text-right text-teal-400">—</td>
                  <td className="px-4 py-3 text-right text-teal-400">—</td>
                  <td className="px-4 py-3 text-right tabular-nums">
                    {purchaseCoinsBreakup?.totalCoins?.toLocaleString()}
                  </td>
