   ...
   <div className="min-h-screen p-2  bg-[#1d8e85]  rounded-xl text-sm sm:text-base md:text-lg overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-4">
          <h1 className="text-xl font-semibold">Total Team Details</h1>
        ...
        {/* Mobile cards */}
        <div className="flex flex-wrap gap-3 lg:hidden rounded-lg">
          {isLoading ? (
            [...Array(3)].map((_, i) => (
            ...
            TableData.map((data, i) => (
              <div key={i} className="p-4 w-full rounded-lg border border-white/20 bg-white/10">
