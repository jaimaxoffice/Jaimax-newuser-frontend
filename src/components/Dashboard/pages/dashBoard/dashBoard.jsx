...
//                               <div className="bg-white/20 rounded-[5px] p-0.5 sm:md:p-0 md:p-3 min-w-[20px] sm:max-w-[20px] md:min-w-[60px] hover:bg-white/30 transition-all duration-300 hover:scale-110">
//                                 <span
//                                   key={timeLeft.days}
...
//                             <div className="text-center">
//                               <div className="bg-white/20 rounded-[5px] p-0.5 md:p-3 sm:md:p-0 min-w-[20px] sm:min-w-[20px] md:min-w-[60px] hover:bg-white/30 transition-all duration-300 hover:scale-110">
//                                 <span
//                                   key={timeLeft.hours}
//                                   className="text-[9px] md:text-sm sm:text-[5px] font-semibold text-white block animate-flip"
//                                 >
...
//                             <div className="text-center">
//                               <div className="bg-white/20 rounded-[5px] p-0.5 md:p-3 sm:md:p-0 min-w-[20px] sm:min-w-[30px] md:min-w-[60px] hover:bg-white/30 transition-all duration-300 hover:scale-110">
//                                 <span
...
//                             <div className="text-center">
//                               <div
//                                 className="bg-white/80 rounded-[5px] p-0.5 md:p-3 sm:md:p-0 
...
const CountdownTimer = lazy(() =>
  import("../../../../pages/popups/CoinPricePopup1")
);
...
// Mobile Countdown Overlay Component
const MobileCountdownOverlay = React.memo(({ timeLeft, isInTimeRange }) => {
  ...
  return (
    <div
      className="
        absolute 
        top-[75%] min-[640px]:top-[25%]
        left-[23%] min-[640px]:left-[28%]
        -translate-x-1/2 
        -translate-y-1/2 
        z-10
      "
    >
      <div className="rounded-lg p-3 sm:p-4 transition-all duration-300">
        <h6 className="hidden sm:block text-white text-[8px] sm:text-xs font-bold mb-2 text-center">
          Time Remaining
        </h6>
        ...
        <div className="flex gap-1.5">
          {/* Days */}
          <div className="text-center">
            <div className="bg-white/20 rounded-[5px] p-0.5 min-w-[20px] sm:max-w-[20px] hover:bg-white/30 transition-all duration-300">
              <span className="text-[9px] sm:text-[5px] font-semibold text-white block">
                {String(timeLeft.days).padStart(2, "0")}
              </span>
            </div>
            <p className="text-white text-[6px] sm:text-[5px]">Days</p>
          </div>

          {/* Hours */}
          <div className="text-center">
            <div className="bg-white/20 rounded-[5px] p-0.5 min-w-[20px] sm:min-w-[20px] hover:bg-white/30 transition-all duration-300">
              <span className="text-[9px] sm:text-[5px] font-semibold text-white block">
                {String(timeLeft.hours).padStart(2, "0")}
              </span>
            </div>
            <p className="text-white text-[6px] sm:text-[5px]">Hours</p>
          </div>

          {/* Minutes */}
          <div className="text-center">
            <div className="bg-white/20 rounded-[5px] p-0.5 min-w-[20px] sm:min-w-[30px] hover:bg-white/30 transition-all duration-300">
              <span className="text-[9px] sm:text-[5px] font-semibold text-white block">
                {String(timeLeft.minutes).padStart(2, "0")}
              </span>
            </div>
            <p className="text-white text-[6px] sm:text-[5px]">Minutes</p>
          </div>

          {/* Seconds */}
          <div className="text-center">
            <div className="bg-white/80 rounded-[5px] p-0.5 min-w-[20px] sm:min-w-[20px] hover:bg-gray-100 transition-all duration-300">
              <span className="text-[9px] sm:text-xs font-semibold text-black block">
                {String(timeLeft.seconds).padStart(2, "0")}
              </span>
            </div>
            <p className="text-white text-[6px] sm:text-xs">Seconds</p>
          </div>
        </div>
      </div>
    </div>
...
MobileCountdownOverlay.displayName = "MobileCountdownOverlay";
...
const handleComplete = (coins) => {
  ...
  // Countdown Timer Logic - For mobile overlay
  useEffect(() => {
    const startDate = new Date("2025-11-26T00:00:00").getTime();
    const endDate = new Date("2025-12-01T00:00:00").getTime();
    ...
    const timer = setInterval(checkTimeRange, 1000);
...
if (!localStorage.getItem("reg_bonus_shown")) {
  ...
  return (
    <div className="min-h-screen p-0 bg-[#1d8e85] rounded-xl text-sm sm:text-base md:text-lg overflow-auto">
      {/* Announcement Slider with Countdown Overlay - Mobile Only */}
      ...
      {/* CountdownTimer Component - Desktop Only */}
      <div className="mb-3 hidden md:block">
