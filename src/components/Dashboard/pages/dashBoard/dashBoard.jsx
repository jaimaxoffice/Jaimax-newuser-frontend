...
//     <>
//       {/*
//         The <style> tag below contains all the necessary CSS.
//         It targets the classNames used in the slider, like 'announcement-slider' and the custom 'slick-dots'.
//       */}
//       <style>{`
//         .announcement-slider {
//           position: relative;
...
//         <div className="announcement-slider max-w-sm sm:max-w-md md:max-w-lg mx-auto rounded-lg overflow-hidden ">
//           <Slider
//             {...settings}
//             dots={true}
//             arrows={false}
