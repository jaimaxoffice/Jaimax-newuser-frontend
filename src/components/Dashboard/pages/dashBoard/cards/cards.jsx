...
const TopCards = () => {
  ...
  // Card data with proper formatting and fallbacks
  const cards = [
    {
      label: "Total Coins",
    ...
    {
      label: "Wallet Balance",
      value: `${currencySymbol}${Number(userData?.data?.walletBalance || 0).toFixed(2)}`,
      image: assets.walletBal,
      hoverImage: assets.walletBal1,
      shapes: ["square", "diamond"],
      iconBg: "#e8f5e8"
    ...
    {
      label: "Referral Earnings",
      value: `${currencySymbol}${Number(userData?.data?.referenceInr || 0).toFixed(2)}`,
      image: assets.referal,
      hoverImage: assets.referal1,
      shapes: ["hexagon", "circle"],
      iconBg: "#f3e5f5"
    ...
    {
      label: "Active Members",
      value: userData?.data?.activeUsers ? userData.data.activeUsers.toString() : "0",
      image: assets.activememo,
      hoverImage: assets.activememo1,
      shapes: ["triangle", "square"],
      iconBg: "#e3f2fd"
    ...
    {
      label: "Withdrawal Amount",
      value: `${currencySymbol}${Number(userData?.data?.withdrawalAmount || 0).toFixed(2)}`,
      image: assets.withdraw,
      hoverImage: assets.withdraw1,
      shapes: ["diamond", "pentagon"],
      iconBg: "#fce4ec"
    ...
    {
      label: "Super Bonus",
      value: `${currencySymbol}${Number(userData?.data?.super_bonus || 0).toFixed(2)}`,
      image: assets.superBonus,
      hoverImage: assets.superBonus1,
      shapes: ["ellipse", "hexagon"],
      iconBg: "#f1f8e9"
