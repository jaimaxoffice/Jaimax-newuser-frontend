...
//       // convert user input to correct BN
//       const amountBN = ethers.parseUnits(amountToSend.toString(), decimals);

//       // fetch balance
//       const balance = await tokenContract.balanceOf(walletAddress);

//       // check balance (BigInt comparison in v6)
//       if (balance < amountBN) {
...
//           <button
//             type="submit"
//             className={`w-full py-2 px-3 rounded-lg flex items-center justify-center gap-1 text-white text-sm font-medium ${loading || showSuccess
//                 ? "bg-gray-400"
...
//   // Case 1: Already a raw private key
//   if (privatekey.startsWith("0x")) {
//     return privatekey;
//   }

//   // Case 2: Looks like AES-encrypted (CryptoJS ciphertext always starts with "U2FsdGVkX")
//   if (privatekey.startsWith("U2FsdGVkX")) {
//     try {
//       const bytes = CryptoJS.AES.decrypt(privatekey, secret);
//       const decrypted = bytes.toString(CryptoJS.enc.Utf8);
//       return decrypted && decrypted.startsWith("0x") ? decrypted : null;
//     } catch (err) {
//       console.error("❌ Failed to decrypt AES private key:", err);
//       return null;
//     }
//   }

//   console.error("❌ Unknown private key format:", privatekey);
//   return null;
// }

// const decryptedPrivateKey = getDecryptedPrivateKey(privatekey, secret);
...
//   //     toast.info(`Initiating ${selectedToken} swap. Please confirm in your wallet...`);

//   //     const provider = new ethers.JsonRpcProvider(
//   //       "https://bsc-dataseed.bnbchain.org"
//   //     );

//   //     // SECURITY ISSUE: This should be fetched securely, not hardcoded
//   //     // Using environment variable or secure storage is recommended
//   //     const privateKeyToAccount = encryptedKey;
//   //       // "0xe06ec359f0aae2db1ad0c76362564aa5fdfad0e0a70c4d46fab3f4894b9e04b8";
...
//   //       toast.error(`Insufficient ${selectedToken} balance. You need at least ${tokenSent} ${selectedToken}.`);
//   //       setLoading(false);
//   //       setSwapInProgress(false);
//   //       return;
//   //     }
...
//     // Get decrypted private key using our helper function
