...
// //     // ✅ Correct way to show backend error
// //     const errorMessage =
...
// // Loading spinner component for consistent loading indicators
// const LoadingSpinner = ({ size = "md", color = "teal", text }) => {
//   const sizeClass = size === "sm" ? "h-4 w-4" : size === "lg" ? "h-6 w-6" : "h-5 w-5";
//   const colorClass = color === "white" ? "text-white" : "text-teal-500";
  
//   return (
//     <div className="flex items-center gap-2">
//       <svg className={`animate-spin ${sizeClass} ${colorClass}`} fill="none" viewBox="0 0 24 24">
