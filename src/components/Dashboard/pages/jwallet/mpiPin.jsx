...
<div className="max-w-md mx-auto mt-4 sm:mt-8 backdrop-blur-md bg-white/70 shadow-lg rounded-xl p-4 sm:p-6 border border-teal-100/50">
  ...
  {formError && (
    <div className="mb-2 sm:mb-3 text-red-600 text-xs sm:text-sm text-center">{formError}</div>
  )}
  ...
  {step === 1 && (
    <form onSubmit={handleRequestOtp} className="space-y-2 sm:space-y-3">
      <div>
        <label className="block text-xs sm:text-sm font-medium mb-1 text-teal-800">PIN</label>
        <input
          type="password"
          maxLength={6}
          minLength={4}
      ...
      <div>
        <label className="block text-xs sm:text-sm font-medium mb-1 text-teal-800">Confirm PIN</label>
        <input
          type="password"
          maxLength={6}
          minLength={4}
  ...
  {step === 2 && (
    <form onSubmit={handleCreatePin} className="space-y-2 sm:space-y-3">
      ...
      <div>
        <label className="block text-xs sm:text-sm font-medium mb-1 text-teal-800">Enter OTP</label>
        <input
          type="text"
          maxLength={6}
          value={otp}
  ...
  {step === 3 && (
    <div className="text-center py-2 sm:py-4">
      <div className="text-teal-600 text-4xl sm:text-5xl mb-2 sm:mb-3">✓</div>
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6 flex flex-col items-center">
        ...
        {step === 1 && (
          <>
            ...
            <button onClick={onClose} className="mt-4 text-teal-600 underline">
              Cancel
            </button>
          </>
        )}
