...
//   return (
//     <div className="min-h-screen bg-[#13b2a1]">
...
//             {/* Profile Card */}
//             <div className="relative bg-white rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-100 overflow-hidden">
//               {/* Background SVG */}
//               <div className="absolute inset-0 opacity-5">
//                 <svg viewBox="0 0 200 200" className="w-full h-full">
//                   <circle cx="160" cy="40" r="30" fill="currentColor" className="text-teal-500"/>
//                   <circle cx="40" cy="160" r="20" fill="currentColor" className="text-blue-400"/>
//                   <path d="M20,180 Q100,120 180,160" stroke="currentColor" strokeWidth="2" fill="none" className="text-teal-400"/>
//                 </svg>
//               </div>
...
//                   </div>
//                   {!isLoading && !loading && (
//                     <span className="bg-teal-50 text-teal-700 text-xs font-medium px-2 py-1 rounded-lg">
//                       {username}
//                     </span>
//                   )}
//                 </div>
...
//                 ) : (
//                   <>
//                     <h5 className="font-bold text-gray-800 mb-2 truncate">{name}</h5>
//                     <div className="space-y-1 text-xs text-gray-600">
//                       <div className="flex items-center">
//                         <Mail className="w-3 h-3 mr-2 text-teal-500" />
//                         <span className="truncate">{email}</span>
//                       </div>
//                       <div className="flex items-center">
//                         <Phone className="w-3 h-3 mr-2 text-teal-500" />
//                         <span>{phone}</span>
//                       </div>
//                     </div>
//                   </>
...
//               <div className="absolute inset-0 opacity-5">
//                 <svg viewBox="0 0 200 200" className="w-full h-full">
//                   <polygon points="100,20 180,180 20,180" fill="currentColor" className="text-emerald-500"/>
//                   <circle cx="100" cy="100" r="40" fill="none" stroke="currentColor" strokeWidth="3" className="text-teal-400"/>
//                 </svg>
//               </div>
...
//                 <div className="flex items-center justify-between mb-3">
//                   <div className="flex items-center">
//                     <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-emerald-100 to-emerald-200 flex items-center justify-center mr-2">
//                       <CheckCircle className="w-4 h-4 text-emerald-600" />
//                     </div>
//                     <h6 className="font-semibold text-gray-800 text-sm">Eligibility</h6>
//                   </div>
//                   {!isLoading && !loading && (
//                     <span className={`px-2 py-1 rounded-lg text-xs font-semibold text-white ${
//                       eligibilityPercentage >= 100 ? 'bg-emerald-500' :
//                       eligibilityPercentage > 50 ? 'bg-yellow-500' : 'bg-red-500'
//                     }`}>
//                       {eligibilityPercentage}%
//                     </span>
//                   )}
...
//                 ) : (
//                   <>
//                     <div className={`inline-block px-3 py-1 rounded-lg text-white font-medium text-xs mb-2 ${
//                       isEligibleForShareHolder 
//                         ? 'bg-emerald-500' 
//                         : 'bg-red-500'
//                     }`}>
...
//               <div className="absolute inset-0 opacity-5">
//                 <svg viewBox="0 0 200 200" className="w-full h-full">
//                   <circle cx="60" cy="60" r="25" fill="currentColor" className="text-blue-500"/>
//                   <circle cx="140" cy="60" r="25" fill="currentColor" className="text-teal-500"/>
//                   <circle cx="100" cy="140" r="30" fill="currentColor" className="text-indigo-500"/>
//                   <line x1="60" y1="60" x2="100" y2="140" stroke="currentColor" strokeWidth="2" className="text-teal-400"/>
//                   <line x1="140" y1="60" x2="100" y2="140" stroke="currentColor" strokeWidth="2" className="text-teal-400"/>
//                 </svg>
//               </div>
              
//               <div className="relative p-5">
//                 <div className="flex items-center mb-3">
//                   <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center mr-2">
//                     <Users className="w-4 h-4 text-blue-600" />
//                   </div>
//                   <h6 className="font-semibold text-gray-800 text-sm">Referrals</h6>
//                 </div>
...
//                       <div className="text-lg font-bold text-teal-600">{directReferrals}</div>
//                       <div className="text-xs text-gray-500">Direct</div>
//                     </div>
//                     <div className="text-center">
//                       <div className="text-lg font-bold text-blue-600">{chainReferrals}</div>
...
//               <div className="absolute inset-0 opacity-5">
//                 <svg viewBox="0 0 200 200" className="w-full h-full">
//                   <path d="M20,180 L50,120 L80,140 L120,80 L160,100 L180,40" stroke="currentColor" strokeWidth="3" fill="none" className="text-emerald-500"/>
//                   <circle cx="180" cy="40" r="8" fill="currentColor" className="text-emerald-600"/>
//                   <polygon points="170,30 190,30 180,10" fill="currentColor" className="text-emerald-600"/>
//                 </svg>
//               </div>
...
//                   </div>
//                   <h6 className="font-semibold text-gray-800 text-sm">Performance</h6>
//                 </div>
...
//                 ) : (
//                   <>
//                     <div className="text-lg font-bold text-emerald-600 mb-1">{qualifiedDirectMembers}</div>
//                     <div className="text-xs text-gray-500 mb-2">Qualified Members</div>
//                     <div className="text-xs text-gray-600 italic">{progressStatus}</div>
//                   </>
//                 )}
//               </div>
//             </div>
...
//                 <div className="flex items-center">
//                   <div className="w-10 h-10 bg-gradient-to-br from-teal-500 to-teal-600 rounded-xl flex items-center justify-center mr-3 shadow-md">
//                     <Users className="w-5 h-5 text-white" />
//                   </div>
//                   <div>
//                     <h5 className="text-gray-800 font-bold text-lg">Direct Referrals</h5>
//                     <div className="flex items-center mt-1">
//                       <span className="text-gray-600 text-sm mr-2">Total entries:</span>
//                       <span className="bg-teal-50 text-teal-700 text-sm font-medium px-2 py-1 rounded-lg">
//                         {isLoading || loading ? (
//                           <div className="w-6 h-4 animate-pulse rounded bg-gray-300"></div>
//                         ) : (
...
//                   <input
//                     type="text"
//                     className="w-full bg-white border border-gray-200 text-gray-800 placeholder-gray-500 px-4 py-2.5 pr-10 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent shadow-sm"
...
//                       <th key={index} className="px-4 py-3 text-left text-sm font-semibold uppercase tracking-wide">
//                         {header}
//                       </th>
//                     ))}
//                   </tr>
...
//                           </div>
//                           <h6 className="text-gray-800 font-semibold mb-1">No referrals found</h6>
//                           <p className="text-gray-500 text-sm max-w-xs">
//                             Try adjusting your search criteria or add new referrals.
//                           </p>
//                         </div>
//                       </td>
//                     </tr>
...
//                           <div className="w-7 h-7 bg-teal-50 border border-teal-200 rounded-lg flex items-center justify-center text-teal-700 text-sm font-semibold">
//                             {indexOfFirstReferral + i + 1}
//                           </div>
//                         </td>
//                         <td className="px-4 py-3">
//                           <div className="font-medium text-gray-800 text-sm">{referral.name}</div>
//                         </td>
//                         <td className="px-4 py-3">
//                           <span className="text-gray-600 font-mono text-xs">{referral.username}</span>
//                         </td>
//                         <td className="px-4 py-3 text-center">
//                           <span className="bg-blue-500 text-white text-xs font-medium px-2 py-1 rounded-lg min-w-[32px] inline-block">
//                             {referral.directReferrals}
//                           </span>
//                         </td>
//                         <td className="px-4 py-3 text-center">
//                           <span className="bg-indigo-500 text-white text-xs font-medium px-2 py-1 rounded-lg min-w-[32px] inline-block">
//                             {referral.chainReferrals}
//                           </span>
//                         </td>
//                         <td className="px-4 py-3 text-center">
//                           <span className="bg-teal-500 text-white text-xs font-medium px-2 py-1 rounded-lg min-w-[32px] inline-block">
...
//                             <div className="flex justify-between items-center mb-1">
//                               <span className="text-gray-700 text-xs font-medium">{referral.taskCompletionPercentage}%</span>
//                             </div>
//                             <div className="bg-gray-200 rounded-full h-2 w-28 overflow-hidden">
//                               <div
...
//                             <span className="bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-semibold px-2 py-1 rounded-lg inline-flex items-center min-w-[80px] justify-center">
//                               <CheckCircle className="w-3 h-3 mr-1" />
//                               Qualified
//                             </span>
//                           ) : referral.eligibilityPercentage > 0 ? (
//                             <span className="bg-yellow-50 border border-yellow-200 text-yellow-700 text-xs font-semibold px-2 py-1 rounded-lg inline-flex items-center min-w-[80px] justify-center">
//                               <Clock className="w-3 h-3 mr-1" />
//                               Pending
//                             </span>
//                           ) : (
//                             <span className="bg-red-50 border border-red-200 text-red-700 text-xs font-semibold px-2 py-1 rounded-lg inline-flex items-center min-w-[80px] justify-center">
...
//           {/* Pagination */}
//           <div className="flex flex-col lg:flex-row justify-between items-center mt-6 bg-white p-4 rounded-2xl shadow-md border border-gray-100 gap-4">
//             <div>
//               {isLoading || loading ? (
//                 <div className="w-48 h-4 animate-pulse rounded bg-gray-300"></div>
//               ) : (
//                 <span className="text-gray-600 text-sm">
//                   Showing {currentReferrals.length > 0 ? indexOfFirstReferral + 1 : 0} to {Math.min(indexOfLastReferral, filteredReferrals.length)} of {filteredReferrals.length} entries
//                 </span>
//               )}
//             </div>
...
//                 <select
//                   className="bg-white border border-gray-200 text-gray-800 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent shadow-sm min-w-[70px]"
//                   value={state.perPage}
...
//                     {[...Array(5)].map((_, i) => (
//                       <div key={i} className="w-9 h-9 animate-pulse rounded-lg bg-gray-300"></div>
//                     ))}
//                   </div>
//                 ) : (
...
//                           <li key={index}>
//                             <button
//                               className={`w-9 h-9 flex items-center justify-center rounded-lg border transition-all duration-200 font-medium text-sm ${
//                                 isActive
...
//                         {state.currentPage > 3 && (
//                           <li>
//                             <span className="w-9 h-9 flex items-center justify-center text-gray-500 bg-white border border-gray-200 rounded-lg">
//                               ...
//                             </span>
//                           </li>
//                         )}
        ...
        >
          ...
          <div className="relative p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              {!isLoading && !loading && (
                <span className={`px-2 py-1 rounded-lg text-xs font-semibold text-white transition-all duration-300 ${
                  eligibilityPercentage >= 100 ? 'bg-emerald-500' :
            ...
            {isLoading || loading ? (
              ...
              <>
                <div className={`inline-block px-3 py-1 rounded-lg text-white font-medium text-xs mb-2 transition-all duration-300 ${
                  isEligibleForShareHolder 
                    ? 'bg-emerald-500' 
                    : 'bg-green-500'
              ...
              <nav className="relative">
                {isLoading || loading ? (
                  ...
                  <ul className="flex items-center gap-2">
                    <li>
                      <button
                        className={`w-10 h-10 flex items-center justify-center rounded-xl border-2 transition-all duration-300 ${
                          state.currentPage === 1 
                            ? 'bg-gray-50 text-gray-400 cursor-not-allowed border-gray-200' 
                    ...
                    {totalPages <= 5 ? (
                      ...
                      [...Array(totalPages)].map((_, index) => {
                        ...
                        return (
                          <li key={index}>
                            <button
                              className={`w-10 h-10 flex items-center justify-center rounded-xl border-2 transition-all duration-300 font-bold text-sm ${
                                isActive
