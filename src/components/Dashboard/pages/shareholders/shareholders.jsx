...
if (
  data?.data &&
  userData.isEligibleForShareHolder === false &&
  userData.photoVerificationCompleted === false
) {
  return (
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-3xl shadow-2xl p-4 max-w-md w-full mx-0 relative border border-gray-100">
          <button
            ...
            className="absolute top-4 right-4 text-gray-400 hover:text-gray-600 text-xl font-bold transition-colors z-[1000]"
          >
            ✕
          </button>
          <ShareholderForm />
