...
//           toast.error("Both name and date of birth have mismatched", {
//             position: "top-center",
//           });
//         }
//       } else {
...
//                     <div className="mt-3 bg-teal-50 border border-green-200 rounded-lg px-3 py-2 space-y-1">
//                       {digilockerName && (
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-3 sm:p-4">
        <div className="relative w-full max-w-sm sm:max-w-md transform overflow-hidden rounded-2xl sm:rounded-3xl bg-white shadow-2xl transition-all">
          
          {/* Close Button */}
          <button
            onClick={onClose}
            className="absolute right-3 top-3 sm:right-4 sm:top-4 p-1.5 rounded-full text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-all z-10"
          >
            ...
            {step === "aadhaar" && (
              <div className="space-y-4 sm:space-y-5">
                <div className="text-center">
                  ...
                  {(digilockerName || digilockerDob) && (
                    <div className="mt-3 bg-teal-50 rounded-xl px-3 py-2 text-left">
                      {digilockerName && (
