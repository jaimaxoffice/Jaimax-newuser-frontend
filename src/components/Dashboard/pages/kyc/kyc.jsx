            ...
            <div className="bg-gradient-to-r from-teal-600 to-teal-700 p-6">
              <div className="flex justify-between items-center flex-wrap gap-4">
                <div className="flex items-center gap-4">
                  <h1 className="text-2xl font-bold text-white">KYC Information</h1>
              ...
              <div className="mt-4 flex items-center gap-6 flex-wrap">
                ...
                {kycdata?.data?.status === "approve" && (
                  <button
                    type="button"
                    className="bg-white bg-opacity-20 hover:bg-opacity-30 text-white px-3 py-2 rounded-lg transition-colors flex items-center gap-2"
                    onClick={onClickEdit}
                  >
                ...
                {kycdata && kycdata?.data?.status === "reject" && (
                  <div className="text-white">
                    ...
                    <span className="ml-2 text-red-200 font-medium">
                      {kycdata?.data?.reason}
                    </span>
                  </div>
                )}
            ...
            <div className="p-6">
              <form className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                  <h2 className="text-xl font-semibold text-gray-900 border-b border-teal-200 pb-2">
                    Applicant Info
                  </h2>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      readOnly
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 text-gray-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                    />
                  ...
                  <div>
                    ...
                    {isCountryCodeIndia
                      ? errors?.aadhar_doc_front && (
                          <p className="mt-1 text-sm text-red-600">{errors.aadhar_doc_front}</p>
                        )
                      : errors?.dl_doc_front && (
                          <p className="mt-1 text-sm text-red-600">{errors.dl_doc_front}</p>
                        )}
                  </div>
                  ...
                  <div>
                    ...
                    {isCountryCodeIndia
                      ? errors?.aadhar_doc_back && (
                          <p className="mt-1 text-sm text-red-600">{errors.aadhar_doc_back}</p>
                        )
                      : errors?.dl_doc_back && (
                          <p className="mt-1 text-sm text-red-600">{errors.dl_doc_back}</p>
                        )}
                  </div>
                  ...
                  <div>
                    ...
                    {isCountryCodeIndia
                      ? errors.pan_doc_front && (
                          <p className="mt-1 text-sm text-red-600">{errors.pan_doc_front}</p>
                        )
                      : errors.passport_doc_front && (
                          <p className="mt-1 text-sm text-red-600">{errors.passport_doc_front}</p>
                        )}
                  </div>
                  ...
                  {!isCountryCodeIndia && (
                    <div>
                      ...
                      {errors.passport_doc_back && (
                        <p className="mt-1 text-sm text-red-600">{errors.passport_doc_back}</p>
                      )}
                    </div>
                  )}
              ...
              <div className="mt-8 flex justify-end space-x-4">
                {kycdata?.success !== 1 && (
                  <button
                    ...
                    disabled={loading}
                    className="bg-teal-600 hover:bg-teal-700 disabled:bg-teal-400 text-white font-semibold py-3 px-6 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 disabled:cursor-not-allowed"
                  >
