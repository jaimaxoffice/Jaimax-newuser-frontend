...
// import { useLocation } from "react-router-dom";
// import { toast } from "react-toastify";
// import { Eye, Edit3, Upload, AlertCircle, CheckCircle2, Clock, XCircle } from "lucide-react";
// import CryptoJS from "crypto-js";
// import digiLocker from '../../../../assets/digilocker.svg';
// import editIcon from "../../../../assets/edit.svg";
// import showIcon from "../../../../assets/showIcon.svg";
...
//     toast.info("DigiLocker integration would be implemented here");
//   };
...
//       <div className="max-w-7xl mx-auto">
//         <div className="bg-gradient-to-r from-teal-600 to-teal-700 rounded-xl shadow-xl p-6 mb-6">
...
//                     className="bg-white text-teal-600 px-4 py-2 rounded-lg font-medium hover:bg-teal-50 transition-colors duration-200 flex items-center gap-2"
//                   >
...
//           {/* Status Section */}
//           <div className="mt-6 flex flex-col lg:flex-row items-start lg:items-center gap-4 pt-4 border-t border-teal-500">
//             <div className="flex items-center gap-2">
//               {kycdata?.data?.status === "approve" && (
//                 <button
//                   type="button"
...
//               <div className="flex items-center gap-2">
//                 {getStatusIcon(kycdata?.data?.status)}
//                 <span className="text-white font-medium">KYC Status:</span>
//                 <span className={`font-bold ${getStatusColor(kycdata?.data?.status)} bg-white px-3 py-1 rounded-full text-sm`}>
//                   {getStatusText(kycdata?.data?.status)}
//                 </span>
//               </div>
//             </div>
...
//               <h3 className="text-xl font-bold text-teal-700 border-b border-teal-200 pb-2">
//                 Applicant Info
//               </h3>
...
//                   disabled
//                   readOnly
//                   className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 text-gray-700 focus:ring-2 focus:ring-teal-500 focus:border-transparent"
//                 />
...
//               <div>
//                 <label className="block text-sm font-medium text-gray-700 mb-2">
//                   {isCountryCodeIndia ? "Aadhar" : "Driving License"} Front{" "}
...
//                     (kycdata?.data?.status == "approve" && !isEditClicked)
//                   }
//                   className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent disabled:bg-gray-50 disabled:text-gray-500 file:mr-4 file:py-1 file:px-3 file:rounded-full file:border-0 file:text-sm file:font-medium file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100"
//                 />
//                 {isCountryCodeIndia
//                   ? errors?.aadhar_doc_front && (
//                       <p className="text-red-500 text-sm mt-1">{errors.aadhar_doc_front}</p>
//                     )
//                   : errors?.dl_doc_front && (
//                       <p className="text-red-500 text-sm mt-1">{errors.dl_doc_front}</p>
//                     )}
//               </div>

//               <div>
//                 <label className="block text-sm font-medium text-gray-700 mb-2">
//                   {isCountryCodeIndia ? "Aadhar" : "Driving License"} Back{" "}
//                   <span className="text-red-500">*</span>
//                   {kycdata?.success && (
//                     <button
//                       type="button"
...
//                       <p className="text-red-500 text-sm mt-1">{errors.aadhar_doc_back}</p>
//                     )
//                   : errors?.dl_doc_back && (
//                       <p className="text-red-500 text-sm mt-1">{errors.dl_doc_back}</p>
//                     )}
//               </div>
...
//                       <p className="text-red-500 text-sm mt-1">{errors.pan_doc_front}</p>
//                     )
//                   : errors.passport_doc_front && (
//                       <p className="text-red-500 text-sm mt-1">{errors.passport_doc_front}</p>
//                     )}
//               </div>
...
//                 <div>
//                   <label className="block text-sm font-medium text-gray-700 mb-2">
//                     Passport Back <span className="text-red-500">*</span>
//                     {kycdata?.success && (
//                       <button
//                         type="button"
//                         onClick={() =>
...
//                     <p className="text-red-500 text-sm mt-1">{errors.passport_doc_back}</p>
//                   )}
//                 </div>
//               )}
...
//                 onClick={handleSubmit}
//                 disabled={loading}
//                 className="bg-gradient-to-r from-teal-600 to-teal-700 text-white px-8 py-3 rounded-lg font-medium hover:from-teal-700 hover:to-teal-800 focus:ring-4 focus:ring-teal-300 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
//               >
//                 {loading ? (
//                   <>
