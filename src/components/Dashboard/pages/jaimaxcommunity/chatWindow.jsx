        ...
        <>
            {
                isComponentLoading ? (
                    ...
                    <div ref={containerRef} className="flex-1 flex flex-col relative h-full  z-[1000]">

                        {selectedGroup && (
                            <div ref={headerRef} className="bg-[#085056] p-2 sm:p-4 flex items-center justify-between border-b border-[#2a3942]">
                        ...
                        {selectedGroup && !showMembers && !showFilesPanel && (
                            <div
                                ref={messagesAreaRef}
                                className="flex-1 overflow-y-auto p-2 sm:p-4 bg-[#0b141a] relative z-10"
                                style={{
                                    overflowAnchor: 'none'
                                }}
                            >
                                                                ...
                                                                >
                                                                    <div className={`relative max-w-[75%] sm:max-w-[60%] rounded-tl-2xl rounded-br-2xl rounded-bl-2xl bg-[#1d8e85] p-3 text-white p-2 sm:p-3 shadow-md ${containerBg}`}>
                                                                        ...
                                                                        {!msg.deletedForEveryone && getFileUrl(msg) && getFileType(msg)?.startsWith('image/') &&
                                                                            !(msg.isreported && msg.isreported.count >= 3) && (
                                                                        ...
                                                                        {!msg.deletedForEveryone && getFileUrl(msg) && !getFileType(msg)?.startsWith('image/') &&
                                                                            !(msg.isreported && msg.isreported.count >= 3 && msg.isreported.isHidden) && (<div className="max-w-xs">
                                                                                <div
                                                                        ...
                                                                        <div className="flex items-center justify-end gap-1 mt-1 text-xs text-gray-400">
                                                                            ...
                                                                            {isUserAllowed && !msg.deletedForEveryone && (
                                                                                <button
                                    ...
                                    <div className="flex flex-col items-center gap-4">
                                        ...
                                        <div className="w-32 h-40 bg-[#202c33] rounded-lg flex flex-col items-center justify-center border border-[#2a3942] shadow-lg">
                                            <div className="w-16 h-16 mb-2 opacity-40">
                                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1} className="w-full h-full text-gray-400">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                </svg>
                                            </div>
                                            <p className="text-xs text-gray-500">No preview available</p>
                                            <p className="text-xs text-gray-500 mt-1">
                                                {selectedDocument.size ? `${(selectedDocument.size / 1024).toFixed(0)} kB` : ''} · {selectedDocument.name?.split('.').pop()?.toUpperCase()}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <>
                                        <div className="flex items-center justify-between px-5 pt-5 pb-3 border-b border-gray-100">
                                            <h3 className="text-[17px] font-semibold text-gray-900">Report to Jaimax</h3>
                                            <button
                                                onClick={() => {
                                                    setShowReportModal(false);
                                                    setReportingMessage(null);
                                        ...
                                        <div className="px-5 py-4 text-[13px] text-gray-600 leading-relaxed border-b border-gray-100">
                                            <p>
                                                This message will be sent to Jaimax. This person won't know you reported them.
                                            </p>
                                            {reportReason === 'block' && (
                                                <p className="mt-2">
                                                    If you report and block, this person won't be able to message you in this group.
                                                </p>
                                            )}
                                        </div>
                                        ...
                                        <div className="px-5 py-3 border-b border-gray-100">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {['Spam', 'Harassment', 'Violence', 'Inappropriate', 'Other'].map((r) => (
                                                    <button
                                                        key={r}
                                                        onClick={() =>
                                        ...
                                        <div className="divide-y divide-gray-100">
                                            ...
                                            >
                                                <span className="text-[16px] font-medium text-red-500">Report and block</span>
                                            ...
                                            <button
                                                onClick={() => {
                                                    ...
                                                    toast.success('Thanks for reporting', {
                                                        message: 'Your feedback helps keep this community safe.',
                                                        duration: 4000,
                                                    });
                                                }}
                                                className="w-full flex items-center justify-between px-5 py-4 hover:bg-orange-50 transition-colors group"
                                            >
                                                <span className="text-[16px] font-medium text-red-500">Report</span>
                                ...
                                <div className="flex-1 flex items-center justify-center bg-[#111b21] px-4 overflow-hidden">
                                    {selectedFile?.type?.startsWith("image/") && filePreview ? (
                                        ...
                                        <div className="flex flex-col items-center justify-center bg-[#e8e8e8] rounded-2xl w-64 h-56 gap-2">
                                            ...
                                            <p className="text-gray-500 text-sm font-medium mt-1">No preview available</p>
                                            <p className="text-gray-400 text-xs">
                                                {selectedFile?.size ? `${Math.round(selectedFile.size / 1024)} kB` : ''} • {selectedFile?.name?.split('.').pop()?.toUpperCase()}
                                            </p>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="bg-[#111b21] px-3 pb-4 pt-2 border-t border-[#2a3942]">
                                    ...
                                    <div className="flex items-center justify-center gap-2 mt-3">
                                        <div className="w-12 h-12 rounded-lg border-2 border-[#00a884] overflow-hidden bg-[#2a3942] flex items-center justify-center flex-shrink-0">
                                            {selectedFile?.type?.startsWith("image/") && filePreview ? (
                                                <img src={filePreview} alt="thumb" className="w-full h-full object-cover" />
                                            ) : (
                                ...
                                <div className="bg-[#202c33] p-2 sm:p-3 border-t border-[#2a3942] z-20">
                                    ...
                                    <div className="flex items-center gap-1 sm:gap-2 relative">
                                        ...
                                        <div className="relative">
                                            ...
                                            {showFileTypeModal && (
                                                <div
                                                    ...
                                                    onClick={(e) => e.stopPropagation()}
                                                >
                                                    <div className="bg-[#233138] rounded-2xl shadow-2xl overflow-hidden w-52 border border-[#2a3942]">
                                                        {/* Photos & Videos */}
                                                        <button
                                                            onClick={() => {
                                                                fileInputRef?.current?.setAttribute("accept", "image/*");
                                                        ...
                                                        >
                                                            <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#BF59CF' }}>
                                                        ...
                                                        <button
                                                            ...
                                                            className="w-full flex items-center gap-3 px-4 py-3 hover:bg-white/5 transition-colors"
                                                        >
                                                            <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#5157AE' }}>
                                                                <File className="w-5 h-5 text-white" />
                                                            </div>
                                                            <span className="text-sm text-white font-medium">Document</span>
                                                        </button>
                                        ...
                                        <input
                                            ...
                                            className={`flex-1 px-3 sm:px-4 py-2 sm:py-3 bg-[#2a3942] text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#085358] placeholder-gray-400 text-sm sm:text-base ${!isUserAllowed ? 'opacity-50 cursor-not-allowed' : ''
                                                }`}
                                        />
                                        {/* <input
                                        ref={inputRef}
