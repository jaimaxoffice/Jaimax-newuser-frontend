...
//       {sparkline && <Sparkline color={highlight ? 'rgba(255,255,255,.7)' : '#1D9E75'} values={sparkline} />}
//     </div>
//   </div>
// );
...
//         {
//           label: 'Investment',
//           main: fmtCurrency(order.investedAmount),
//           sub: `${fmt(order.tokens)} JMC`,
//         },
//         {
//           label: 'Progress',
//           custom: (
...
//                   {order.progressPercent.toFixed(1)}%
//                 </span>
...
//         {
//           label: 'Daily reward',
//           main: `${fmt(order.dailyDisbursementStakingTokens)} JMC`,
//           sub: `+${fmt(order.dailyReferralStakingTokens)} referral`,
//         },
//         {
//           label: 'Days left',
//           main: order.remainingDays,
//           sub: 'remaining',
//         },
//       ].map((cell, i) => (
//         <div key={i} style={{
...
//         }}>
//           <div style={{ fontSize: 10, color: '#9ca3af', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '.05em', marginBottom: 4 }}>
//             {cell.label}
//           </div>
//           {cell.custom || (
//             <>
...
//   const [currentView, setCurrentView] = useState('dashboard'); // 'dashboard' | 'staking-rewards' | 'referral-rewards'
...
//                         <OrderRow order={order} index={i} onView={handleView} />
//                       </div>
//                       <div className="show-mobile">
//                         <OrderCard order={order} index={i} onView={handleView} />
//                       </div>
//                     </div>
//                   ))}
//                 </div>
