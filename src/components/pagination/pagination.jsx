...
const Pagination = ({ currentPage, totalPages, onPageChange }) => {
  ...
  return (
    <nav 
      className="flex justify-center items-center w-full px-2 py-4 overflow-x-auto scrollbar-hide" 
    ...
    >
      <div className="flex items-center gap-1.5 sm:gap-2 px-3 py-2.5 sm:px-5 sm:py-3.5 
                    ...
                    transform transition-all duration-500 hover:shadow-xl overflow-x-auto scrollbar-hide">
        {/* Previous Button */}
        <button
