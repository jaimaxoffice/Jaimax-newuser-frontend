            ...
            <div className="bg-white w-full max-w-4xl h-[90vh] md:h-[85vh] rounded-lg shadow-xl flex flex-col">
                    ...
                    >
                        <div className="prose prose-sm md:prose-base max-w-none">
                            ...
                            <p className="text-gray-700 mb-4">
                             ...
                             <h5 className="text-lg font-semibold text-gray-900 mt-6 mb-3">10. Acceptance of Risk</h5>
                            <p className="text-gray-700 mb-4">
                            ...
                            <h5 className="text-lg font-semibold text-gray-900 mt-6 mb-3">11. Contact Information</h5>
                            <p className="text-gray-700 mb-8">
                ...
                <div className="border-t border-gray-200 bg-gray-50 px-4 md:px-6 py-4 rounded-b-lg">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                        ...
                        <button
                            type="button"
                            className={`w-full sm:w-auto px-6 py-2 md:py-3 text-white font-semibold rounded-full transition-all duration-200 ${isAgreeEnabled
