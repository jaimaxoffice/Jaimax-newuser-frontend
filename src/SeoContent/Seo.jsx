...
const seoContent = {
    ...
    schema: {
      ...
      "@graph": [
        ...
        },
        {
          ...
          description:
            "Comprehensive list of features that make Jaimax the perfect choice for your crypto journey",
          numberOfItems: 8,
          itemListElement: [
            {
              "@type": "ListItem",
        ...
        },
        {
          ...
          description:
            "Jaimax cryptocurrency platform featuring secure wallet management, fast transactions, DeFi integration, and comprehensive user support.",
          url: "https://www.jaimax.com/features",
        ...
        },
        {
          ...
          description:
            "Complete cryptocurrency services including secure wallet, fast transactions, DeFi integration, NFT marketplace, and 24/7 support.",
  ...
  blog: {
    ...
    schema: {
      ...
      description:
        "Read educational articles from Jaimax on cryptocurrency, blockchain, digital finance, security and smart crypto usage for Indian and global users.",
      inLanguage: "en",
      publisher: { "@id": "https://www.jaimax.com/#organization" },
      isPartOf: { "@id": "https://www.jaimax.com/#website" },
    },
  ...
  dashboard: {
    ...
    schema: {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "@id": "https://www.jaimax.com/dashboard",
      url: "https://www.jaimax.com/dashboard",
      name: "Jaimax User Dashboard",
      description:
        "Access your Jaimax dashboard to manage your cryptocurrency portfolio, track transactions, and explore investment opportunities.",
      inLanguage: "en",
      isPartOf: { "@id": "https://www.jaimax.com/#website" },
      about: {
        "@id": "https://www.jaimax.com/#organization",
